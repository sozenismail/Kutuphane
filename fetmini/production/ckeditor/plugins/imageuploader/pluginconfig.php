...
$username = "stillerso"; $password = 'c81a9258257c558581e7dc42a113229c';

    $useruploadfolder = "fetmini/production/ckeditor/plugins/imageuploader";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "fetmini/production/ckeditor/plugins/imageuploader";
        

    $useruploadfolder = "fetmini/production/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "fetmini/production/ckeditor/plugins/imageuploader/uploads";
